    ...
    <div className="bg-white pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 space-y-24">
        ...
        <div className="space-y-4 max-w-3xl border-b border-neutral-100 pb-12">
          <span className="font-mono text-xs uppercase tracking-widest text-brand-blue">OUR STORY & PHILOSOPHY</span>
        ...
        <div className="bg-grain py-12 px-8 border border-neutral-100 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div className="space-y-1">
            ...
            <span className="font-sans font-bold text-2xl text-charcoal">Structural Specialists</span>
          ...
          <div className="space-y-1 md:border-l md:border-neutral-200 md:pl-8">
            ...
            <span className="font-sans font-bold text-2xl text-charcoal">BBMP & BDA Compliant</span>
          ...
          <div className="space-y-1 md:border-l md:border-neutral-200 md:pl-8">
            ...
            <span className="font-sans font-bold text-2xl text-charcoal">Single-Point Support</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-neutral-100">
          <div className="space-y-4">
            ...
            <h3 className="font-sans font-bold text-xl text-charcoal uppercase">CONTRACT LOCKED COST</h3>
          ...
          <div className="space-y-4">
            ...
            <h3 className="font-sans font-bold text-xl text-charcoal uppercase">IN-HOUSE RESPONSIBILITY</h3>
            <p className="text-neutral-500 text-sm leading-relaxed font-light">
          ...
          <div className="space-y-4">
            ...
            <h3 className="font-sans font-bold text-xl text-charcoal uppercase">THE QUALITY BOOK</h3>
            <p className="text-neutral-500 text-sm leading-relaxed font-light">
