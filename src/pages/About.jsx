...
export default function About() {
  ...
  return (
    <div className="w-full flex flex-col bg-charcoal text-ivory selection:bg-bronze selection:text-charcoal pt-0 select-none">
      ...
      {/* 2. FOUNDER'S VISION & DESIGN PHILOSOPHY */}
      <section className="py-space-96 md:py-space-160 px-space-24 md:px-space-40 border-t border-white/5 bg-graphite relative">
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-space-32 text-center items-center relative z-10">
          <span className="h-label-mono text-bronze">[02 // DESIGN MANDATE]</span>
          
          <blockquote className="font-display text-2xl md:text-4xl font-light italic leading-relaxed text-white">
          ...
          <div className="flex flex-col gap-1.5 mt-4">
            <span className="font-display text-lg font-light text-white">Maaz Ayoob</span>
      ...
      <section className="py-space-96 md:py-space-160 px-space-24 md:px-space-40 border-t border-white/5 bg-charcoal">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-space-48">
          <div className="lg:col-span-4 flex flex-col gap-space-16">
            <span className="h-label-mono text-bronze">[03 // STUDIO TIMELINE]</span>
            <h2 className="font-display text-3xl font-light text-white uppercase tracking-wide">Historical Ledger</h2>
            <p className="font-sans text-xs text-ivory/60 leading-relaxed font-light mt-2 max-w-xs">
          ...
          <div className="lg:col-span-8 flex flex-col gap-space-40 border-l border-white/10 pl-space-32">
            <div className="relative">
              <span className="font-mono text-xs text-bronze block font-semibold">2014 // STUDIO FOUNDING</span>
              <p className="font-sans text-xs text-ivory/70 mt-2 font-light leading-relaxed">
            ...
            <div className="relative">
              <span className="font-mono text-xs text-bronze block font-semibold">2018 // BIM CAD ARCHIVES</span>
              <p className="font-sans text-xs text-ivory/70 mt-2 font-light leading-relaxed">
            ...
            <div className="relative">
              <span className="font-mono text-xs text-bronze block font-semibold">2022 // COMPRESSIVE CUBE MANDATE</span>
              <p className="font-sans text-xs text-ivory/70 mt-2 font-light leading-relaxed">
      ...
      <section className="py-space-96 md:py-space-160 px-space-24 md:px-space-40 border-t border-white/5 bg-graphite relative">
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col gap-space-48 relative z-10">
          <span className="h-label-mono text-bronze">[04 // CLIENT STORIES]</span>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-space-32">
            <div className="border border-white/5 p-space-32 bg-charcoal/40 rounded-sm flex flex-col gap-space-24 justify-between">
              ...
              <div className="flex flex-col gap-1">
                <span className="font-mono text-[9px] text-bronze font-bold">DR. ADITYA SEN</span>
                <span className="font-mono text-[8px] text-ivory/40 uppercase">OWNER // THE EMERALD TERRACES</span>
              </div>
            </div>
            ...
            <div className="border border-white/5 p-space-32 bg-charcoal/40 rounded-sm flex flex-col gap-space-24 justify-between">
              ...
              <div className="flex flex-col gap-1">
                <span className="font-mono text-[9px] text-bronze font-bold">KIRAN RAO</span>
                <span className="font-mono text-[8px] text-ivory/40 uppercase">OWNER // KORAMANGALA MONOLITH</span>
              </div>
            </div>
          </div>
        </div>
