...
export default function Contact() {
  ...
  return (
    <div className="w-full flex flex-col bg-charcoal text-ivory selection:bg-bronze selection:text-charcoal pt-space-96 select-none font-sans">
      ...
      <section ref={formRef} className="py-space-96 px-space-24 md:px-space-40 border-t border-white/5 bg-graphite relative">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-space-64 items-start relative z-10">
          ...
          {/* Glass Form */}
          <div className="col-span-12 lg:col-span-7 border border-white/10 bg-charcoal/50 p-space-32 md:p-space-40 shadow-2xl rounded-sm">
            {submitted ? (
          ...
          <div className="col-span-12 lg:col-span-5 flex flex-col gap-space-48">
            ...
            {/* Offices */}
            <div className="flex flex-col gap-space-24 border-b border-white/5 pb-8">
              <span className="h-label-mono text-bronze">[OFFICE COORDINATES]</span>
              
              <div className="flex flex-col gap-4 font-light text-xs text-ivory/70">
            ...
            <div className="w-full aspect-[4/3] border border-white/10 bg-charcoal rounded-sm overflow-hidden relative">
              <div className="absolute inset-0 blueprint-grid opacity-10"></div>
              <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
                <span className="font-mono text-[8px] text-bronze uppercase">MAP Telemetry // RC_LOC_COORD</span>
      ...
      <section className="py-space-96 px-space-24 md:px-space-40 max-w-5xl mx-auto w-full relative z-10 border-t border-white/5">
        <div className="flex flex-col gap-space-48">
          <div className="flex flex-col gap-space-8 text-center items-center">
            <span className="h-label-mono text-bronze">[TECHNICAL BRIEFINGS // FAQ]</span>
                ...
                >
                  ...
                  >
                    <div className="flex gap-space-16 items-start">
                      ...
                      <h3 className="font-display text-base md:text-lg font-light text-ivory hover:text-bronze transition-colors tracking-wide leading-snug">
                        {item.q}
                      </h3>
                    </div>
